...
3T MCP requires a 3T account. Authentication happens once; credentials are stored locally and reused automatically.
...
Authenticate with 3T. Opens your browser to complete sign-in. Call this when other tools return an authentication error.
