...
**1.1** In this Agreement (except where the context otherwise requires) the following words and phrases shall have the following meanings:
...
* **"Licence Period"** means the period during which the Customer may use the Software pursuant to the Licence, commencing on the Agreement Start Date and continuing unless or until this Agreement is terminated in accordance with its terms;  
...
* **"PII Scanning Feature"** means the scan\_pii tool included within the Software that samples documents from a MongoDB collection and classifies fields by personally identifiable information risk category, as further described in the Documentation;  
...
**1.2** References to a statute or statutory provision include any modification, re-enactment or extension of it and any subordinate legislation made under it in force from time to time. References to the singular include the plural and vice versa. Headings are for convenience only and shall not affect interpretation.

---

## **2 Licence Grant**

**2.1** The Supplier hereby grants to the Customer a non-exclusive, non-transferable, royalty-free right to use (and to permit the Authorised Users to use) the Software and the Documentation during the Licence Period for the Customer's internal business purposes only, at all times in accordance with the terms of this Agreement.
...
**4.1** The Customer shall not, and shall ensure that the Authorised Users do not:

* (a) use the Software or Documentation for any purpose other than the Customer's internal business purposes;  
* (b) use the Software to access any MongoDB instance or database that the Customer or the relevant Authorised User is not authorised to access;  
* (c) use the Software as a component in, or to build, any product or service that competes with the Software or with any product or service offered by the Supplier;  
* (d) use the Software to provide managed services, bureau services, or similar services to third parties;  
* (e) license, sell, rent, lease, transfer, assign, distribute, disclose or otherwise commercially exploit, or otherwise make the Software or Documentation available to any third party except the Authorised Users;  
* (f) distribute, publish or make available any modified version of the Software under the Studio 3T, 3T, or 3T Software Labs name, brand or trade marks;  
* (g) reproduce, modify, adapt, merge, translate, disassemble, decompile, recompile or reverse engineer the Software or create derivative works based on the whole of or any part of the Software.  
* (h) attempt to obtain, or assist third parties in obtaining, access to the Software or Documentation other than as permitted under this Agreement;  
* (i) use the PII Scanning Feature in violation of any applicable data protection or privacy law or regulation; or  
* (j) introduce or permit the introduction of any Viruses into the Supplier's systems or networks.

**4.2** The Software does not permit write operations to MongoDB databases by default. Write operations are disabled unless explicitly enabled by an Authorised User using the `--allow-writes` server flag. The Customer accepts sole responsibility for all consequences of enabling write operations, including any loss or corruption of data.

---

## **5 Authorised Users**

**5.1** The Customer undertakes to procure that each Authorised User shall keep their Account credentials secure and confidential and shall not share them with any other individual.

**5.2** The Customer shall use all reasonable endeavours to prevent any unauthorised access to, or use of, the Software and/or the Documentation and, in the event of any such unauthorised access or use, shall promptly notify the Supplier.

**5.3** The Customer shall ensure that the Authorised Users use the Software and the Documentation in accordance with the terms of this Agreement and shall be responsible and liable for any breach of this Agreement by the Authorised Users.

---

## **6 Documentation**

**6.1** The Customer may possess and refer to the Documentation solely for the purposes of using the Software in accordance with the terms of this Agreement and shall not make the Documentation available for use by any third party.

**6.2** The Customer shall not copy the whole or any part of the Documentation, and shall not remove any trade mark, copyright or proprietary notices from the Documentation.

---

## **7 Updates and Changes to the Software**

**7.1** The Supplier may, from time to time, release updates, patches or new versions of the Software. Updates are made available via the Software's update command (`stt-cli update`) and through the GitHub repository at [https://github.com/3tio/3t-mcp-releases/releases](https://github.com/3tio/3t-mcp-releases/releases).

**7.2** The Software does not include an automatic update mechanism. The Customer is solely responsible for monitoring for and applying updates. The Supplier recommends that the Customer apply updates promptly to benefit from security fixes and improvements.

**7.3** The Supplier reserves the right to modify, update or discontinue the Software or any feature of the Software at any time without notice. The Supplier shall have no liability to the Customer in respect of any such modification, update or discontinuation.

---

## **8 Support**

**8.1** The Software is provided without any commercial support commitment. The Supplier does not guarantee any response to support requests and shall have no obligation to resolve any reported defect or issue.

**8.2** Community support for the Software is available via the GitHub repository at [https://github.com/3tio/3t-mcp-releases](https://github.com/3tio/3t-mcp-releases). Whilst the Supplier may, at its discretion, respond to issues raised through community channels, it is under no obligation to do so.

**8.3** The Supplier reserves the right to provide or withdraw community support at its sole discretion at any time.
...
## **10 PII Scanning Feature — User Responsibility**

**10.1** The Software includes a PII Scanning Feature, which enables Authorised Users to sample documents from a MongoDB collection and classify fields by personally identifiable information risk category. The PII Scanning Feature operates entirely on the Customer's own infrastructure. In no circumstances does any data analysed by the PII Scanning Feature pass through or reach any systems operated by the Supplier.

**10.2** The PII Scanning Feature is a technical assistance tool. The results it produces are indicative only and may be incomplete, inaccurate, or subject to false positives or false negatives. The Supplier makes no warranty as to the accuracy, completeness or reliability of any scan results, and scan results do not constitute legal advice or a compliance assessment.
...
## **11 Relationship to Paid Products**

**11.1** 3T MCP is a standalone free product. The Licence granted under this Agreement does not include, and does not imply or confer, any right of access to any paid product, service or feature offered by the Supplier.

**11.2** Customers wishing to access paid platform features must obtain a separate commercial licence from the Supplier on terms to be agreed separately. Nothing in this Agreement shall be construed as a commitment by the Supplier to make any paid product or feature available to the Customer on any particular terms or at all.

**11.3** If the Customer subsequently obtains a subscription to a paid product of the Supplier, the terms of that subscription will govern the Customer's use of those paid features. This Agreement shall continue to govern the Customer's use of the Software unless superseded by a separate agreement between the parties.

---

## **12 Intellectual Property Rights**

**12.1** The Customer acknowledges that the Supplier owns, or is licensed to use, all copyright and other Intellectual Property Rights of whatever nature in and relating to the Software and the Documentation.
...
**17.1** **Waiver.** The failure or delay of the Supplier to exercise or enforce any right under this Agreement shall not operate as a waiver of that right or preclude the exercise or enforcement of it at any time or times thereafter.

**17.2** **Force Majeure.** Neither party shall be liable for any delay in or failure to perform its obligations under this Agreement if that delay or failure is caused by circumstances beyond the reasonable control of that party, including, without limitation, fires, strikes, insurrection, riots, embargoes, or regulations of any civil or military authority.

**17.3** **Entire Agreement.** This Agreement constitutes the entire agreement and understanding between the parties with respect to the subject matter of this Agreement and supersedes, cancels and replaces all prior agreements, licences, negotiations and discussions between the parties relating to it. The Customer confirms and acknowledges that it has not been induced to enter into this Agreement by, and shall have no remedy in respect of, any statement, representation, warranty or undertaking (whether negligently or innocently made) not expressly incorporated into it. Nothing in this Agreement purports to exclude liability for any fraudulent statement or act.

**17.4** **Updates to this Agreement.** The Supplier reserves the right to update or amend this Agreement from time to time. Any updates will be published at [studio3t.com/mcp/releases](https://studio3t.com/mcp/releases) and/or notified to the Customer by email to the address registered with the Account. Continued use of the Software after the effective date of any updated Agreement constitutes acceptance of the updated terms.

**17.5** **Assignment.** The Customer shall not be entitled to assign this Agreement nor any of its rights or obligations hereunder, nor sub-license the use of the Software or the Documentation. The Supplier may assign or novate this Agreement to any member of its group or to a successor entity in the context of a merger, acquisition or restructuring without the Customer's consent.

**17.6** **Third Parties.** The Contracts (Rights of Third Parties) Act 1999 shall not apply to this Agreement, and nothing in this Agreement shall confer or purport to confer on any third party any benefit or any right to enforce any term of this Agreement.

**17.7** **Anti-Bribery.** Each party shall: (i) comply with all applicable laws, statutes, regulations and codes relating to anti-bribery and anti-corruption, including but not limited to the UK Bribery Act 2010; (ii) have and maintain in place throughout the Licence Period its own policies and procedures designed to ensure compliance with anti-bribery and anti-corruption laws; and (iii) promptly report to the other party any request or demand for any undue financial or other advantage of any kind made or received in connection with the performance of this Agreement.
...
**17.9** **Complaints.** Any complaints about this Agreement or the Software should be raised with the Supplier at [https://studio3t.com/contact-us/](https://studio3t.com/contact-us/) or such other contact address as the Supplier notifies from time to time.

**17.10** **Notices.** Any formal notice to be given under this Agreement shall be in writing and shall be delivered by hand, sent by first-class post, or sent by email. Notices shall be deemed to have been served: if delivered by hand — at the time of delivery; if sent by first class post — upon the expiration of 48 hours after posting; and if sent by email — at the time of transmission, provided that no automated delivery failure notification is received by the sender within 24 hours of sending. Notices to the Supplier can be sent via [https://studio3t.com/contact-us/](https://studio3t.com/contact-us/) or to the Supplier's registered office address. Notices to the Customer shall be sent to the email address or postal address registered with the Customer's Account, or such other address as the Customer may notify the Supplier in writing from time to time.

**17.11** **Governing Law.** This Agreement and any dispute or claim arising out of or in connection with it or its subject matter or formation (including non-contractual disputes or claims) shall be governed by and construed in accordance with the law of England and Wales.

**17.12** **Jurisdiction.** The parties irrevocably agree that the courts of England and Wales shall have non-exclusive jurisdiction to settle any dispute or claim that arises out of or in connection with this Agreement or its subject matter or formation (including non-contractual disputes or claims).
